		...
		<table class="layui-table table-sort" lay-skin="line">
			...
			<c:forEach items="${llist }" var="pic">
				<tr class="text-c">
					...
					<td>${pic.lid }</td>
					<td>${pic.lname }</td>
					<td><a href="javascript:;" onClick="picture_edit('图库编辑','picture-show2.jsp',${pic.lid })"><img width="210" class="picture-thumb" src="../img/pcdetail/${pic.picname }"></a></td>
					<td class="text-l"><a class="maincolor" href="javascript:;" onClick="picture_edit('图库编辑','picture-show2.jsp',${pic.lid })">${pic.picname }</a></td>
...
function picture_edit(title,url,id){
	...
	request.open("post","bmanager.do?p=showdetailpic&lid="+id+"&x="+Math.random());
	request.send(null);
