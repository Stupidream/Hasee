...
/**
 	* A data access object (DAO) providing persistence and search support for Addresses entities.
 			* Transaction control of the save(), update() and delete() operations 
		can directly support Spring container-managed transactions or they can be augmented	to handle user-managed Spring transactions. 
		Each of these methods provides additional information for how to configure it for the desired type of transaction control. 	
	 * @see com.pojo.Addresses
  * @author MyEclipse Persistence Tools 
 */
public class AddressesDAO extends HibernateDaoSupport  {
	     private static final Logger log = LoggerFactory.getLogger(AddressesDAO.class);
    ...
    public Addresses findById( java.lang.Integer id) {
        ...
        try {
            Addresses instance = (Addresses) getHibernateTemplate()
                    .get("com.pojo.Addresses", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Addresses merge(Addresses detachedInstance) {
        ...
        try {
            Addresses result = (Addresses) getHibernateTemplate()
	...
	public static AddressesDAO getFromApplicationContext(ApplicationContext ctx) {
    	return (AddressesDAO) ctx.getBean("AddressesDAO");
	}
}