...
/**
 	* A data access object (DAO) providing persistence and search support for Sales entities.
...
public class SalesDAO extends HibernateDaoSupport  {
    ...
    public Sales findById( java.lang.Integer id) {
        ...
        try {
            Sales instance = (Sales) getHibernateTemplate()
                    .get("com.pojo.Sales", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Sales merge(Sales detachedInstance) {
        ...
        try {
            Sales result = (Sales) getHibernateTemplate()
