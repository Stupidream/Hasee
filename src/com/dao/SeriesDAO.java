...
/**
 	* A data access object (DAO) providing persistence and search support for Series entities.
...
public class SeriesDAO extends HibernateDaoSupport  {
    ...
    public Series findById( java.lang.Integer id) {
        ...
        try {
            Series instance = (Series) getHibernateTemplate()
                    .get("com.pojo.Series", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Series merge(Series detachedInstance) {
        ...
        try {
            Series result = (Series) getHibernateTemplate()
